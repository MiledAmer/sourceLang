...
const char* output_filename = "output.html";
FILE* html_file = NULL;
...
// Nouvelle fonction pour générer un fichier HTML
void generate_html_file(const char* format, ...) {
    // Ouvrir le fichier s'il n'est pas déjà ouvert
    if (html_file == NULL) {
        html_file = fopen(output_filename, "w");
        if (html_file == NULL) {
        ...
        fprintf(html_file, "    <title>Document généré</title>\n");
        fprintf(html_file, "</head>\n<body>\n");
        fprintf(html_file, format);
    }
    
    // Utiliser les arguments variables pour écrire dans le fichier
    // va_list args;
    // va_start(args, format);
    // vfprintf(html_file, format, args);
    // va_end(args);
}

// Fonction pour fermer le fichier HTML
void close_html_file() {
    if (html_file != NULL) {
        // Ajouter la fermeture du body et html
...
{
       0,     0,     3,     5,    14,    15,    17,    19,    23,    27,
      28,    34,    36,    39,    43,    45,    48,    54,    57,    62,
      64,    67,    68,    74,    79,    81,    85,    90,    92,    96
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      22,     0,    -1,    23,    -1,     3,    13,     6,    24,     7,
       4,    27,     5,    -1,    -1,    25,    -1,    26,    -1,    25,
      11,    26,    -1,    13,    12,    13,    -1,    -1,    14,     6,
      28,     7,    18,    -1,    29,    -1,    28,    29,    -1,    31,
      28,    34,    -1,    35,    -1,    30,    29,    -1,     8,    13,
      32,    10,     9,    -1,     8,     9,    -1,     8,    13,    32,
       9,    -1,    33,    -1,    32,    33,    -1,    -1,    13,    16,
      15,    13,    15,    -1,    13,    16,    15,    15,    -1,    13,
      -1,     8,    10,     9,    -1,     8,    10,    13,     9,    -1,
      13,    -1,     4,    13,     5,    -1,    -1
};
...
{
       0,   285,   285,   312,   323,   324,   328,   330,   341,   359,
     360,   381,   388,   399,   410,   419,   430,   441,   450,   465,
     469,   478,   484,   492,   499,   509,   517,   528,   535,   572
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LPAREN", "RPAREN", "LT", "GT", "SLASH", "COMMA", "COLON", "IDENTIFIER",
  "RETURN", "DOUBLE_QUOTE", "EQUALS", "TYPE", "SEMICOLON", "FROM",
  "IMPORT", "$accept", "program", "element", "parameters",
  "typed_param_list", "typed_param", "function", "html_content_list",
  "html_content", "html_balise_autoferme", "html_balise_open",
  "attributes", "attribute", "html_balise_close", "html_inner", 0
};
#endif
...
{
       0,     0,     0,     2,     0,     1,     4,     0,     0,     5,
       6,     0,     0,     0,     8,     9,     7,     0,     0,    29,
       3,     0,     0,    27,     0,    11,    29,     0,    14,     0,
      17,    21,     0,    12,    15,     0,    28,    24,     0,    19,
      10,     0,    13,     0,    18,     0,    20,     0,     0,    16,
      25,     0,     0,    23,    26,    22
};
...
{
      22,     1,    17,   -25,    23,   -25,    15,    18,    24,    21,
     -25,    20,    30,    15,   -25,    25,   -25,    29,    31,    -1,
     -25,    27,    13,   -25,    -3,   -25,    -1,    -1,   -25,    32,
     -25,    28,    26,   -25,   -25,     5,   -25,    33,     6,   -25,
     -25,    11,   -25,    35,   -25,    34,   -25,    14,    -7,   -25,
     -25,    36,    37,   -25,   -25,   -25
};
...
{
      33,    21,    34,    21,    32,    22,    52,    22,    53,    21,
      23,    33,    23,    41,     4,    44,    45,     5,    23,    37,
      30,    47,    30,    50,    31,     1,    31,    51,     7,     6,
      11,    12,    13,    14,    15,    19,    20,    36,    46,    17,
      29,    37,     0,    49,    40,    54,    35,     0,     0,    43,
      48,    16,    55
};

static const yytype_int8 yycheck[] =
{
      24,     4,    26,     4,     7,     8,    13,     8,    15,     4,
      13,    35,    13,     8,    13,     9,    10,     0,    13,    13,
       9,    10,     9,     9,    13,     3,    13,    13,    13,     6,
      12,     7,    11,    13,     4,     6,     5,     5,    38,    14,
      13,    13,    -1,     9,    18,     9,    27,    -1,    -1,    16,
      15,    13,    15
};
...
{
       0,     3,    22,    23,    13,     0,     6,    13,    24,    25,
      26,    12,     7,    11,    13,     4,    26,    14,    27,     6,
       5,     4,     8,    13,    28,    29,    30,    31,    35,    13,
       9,    13,     7,    29,    29,    28,     5,    13,    32,    33,
      18,     8,    34,    16,     9,    10,    33,    10,    15,     9,
       9,    13,    13,    15,     9,    15
};
...
#line 286 "parser.y"
    {
        ...
        generate_html_file(output_buffer);

        close_html_file(); // Fermer le fichier HTML
        
        // Ajouter la fonction pour fermer le fichier HTML dans le main
        printf("\nint main() {\n");
        printf("    // Appeler la fonction pour générer le HTML\n");
        printf("    render();\n");
        printf("    // Fermer le fichier HTML\n");
        printf("    close_html_file();\n");
        printf("    return 0;\n");
        printf("}\n");
...
#line 361 "parser.y"
    { 
        char* tmp = malloc(strlen((yyvsp[(3) - (5)].strval)) + 50); // Allouer mémoire pour printf
        sprintf(tmp, "\n\t%s", (yyvsp[(3) - (5)].strval));
        ...
        (yyval.strval) = tmp;  // Retourner la chaîne générée
    ;}
    break;
...
#line 382 "parser.y"
    { 
        char* tmp = malloc(strlen((yyvsp[(1) - (1)].strval)) + 1); // Allouer mémoire pour le contenu HTML
...
#line 389 "parser.y"
    { 
        char* tmp = malloc(strlen((yyvsp[(1) - (2)].strval)) + strlen((yyvsp[(2) - (2)].strval)) + 1); // Allouer mémoire pour le contenu HTML
...
#line 431 "parser.y"
    {
        char* tmp = malloc(strlen((yyvsp[(2) - (5)].strval)) +strlen((yyvsp[(3) - (5)].strval))+ 3); // "<tag/>"
        sprintf(tmp, "%s %s", (yyvsp[(2) - (5)].strval), (yyvsp[(3) - (5)].strval));
...
#line 451 "parser.y"
    {
        char* tmp = malloc(strlen((yyvsp[(2) - (4)].strval))+strlen((yyvsp[(3) - (4)].strval))+ 3); // "<tag>"
        sprintf(tmp, "%s %s", (yyvsp[(2) - (4)].strval),(yyvsp[(3) - (4)].strval));
        
        // Empiler l'identifiant pour vérification ultérieure
        empiler_tag((yyvsp[(2) - (4)].strval));
...
#line 493 "parser.y"
    {
        char* tmp = malloc(strlen((yyvsp[(1) - (4)].strval)) + 10);
        sprintf(tmp, "%s=''", (yyvsp[(1) - (4)].strval));
...
#line 500 "parser.y"
    {
        ...
        char* tmp = malloc(strlen((yyvsp[(1) - (1)].strval)) + 10);
        sprintf(tmp, "%s", (yyvsp[(1) - (1)].strval));
        free((yyvsp[(1) - (1)].strval));
        (yyval.strval) = tmp;
    ;}
...
#line 518 "parser.y"
    {
        ...
        verifier_tag_fermant((yyvsp[(3) - (4)].strval));
        free((yyvsp[(3) - (4)].strval));
        (yyval.strval) = tmp;
    ;}
    break;
